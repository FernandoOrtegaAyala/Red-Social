...
export default function ExitButtonToolbar({
  ...
  return (
    <>
      <AlertDialog>
        <AlertDialogTrigger className="z-[800] w-6 h-6 mx-3 lg:mx-0 lg:py-2 lg:ml-2 lg:w-full lg:h-auto lg:flex lg:flex-row lg:items-start lg:justify-start text-red-800 lg:hover:bg-red-700 lg:hover:text-white lg:hover:rounded-md">
